...
exports.BASE_SYSTEM_PROMPT = exports.MODEL = exports.SITE_API_BASE = exports.anthropic = void 0;
exports.callSiteApi = callSiteApi;
const sdk_1 = __importDefault(require("@anthropic-ai/sdk"));
exports.anthropic = new sdk_1.default({
    apiKey: process.env.ANTHROPIC_API_KEY,
});
exports.SITE_API_BASE = process.env.SITE_API_BASE || 'https://www.cloudcraftwithfranck.org';
exports.MODEL = 'claude-sonnet-4-6';
exports.BASE_SYSTEM_PROMPT = `You are an AI assistant powered by the GovCloud MCP server built by Franck Kengne — Principal Cloud & DevSecOps Architect at cloudcraftwithfranck.org.
...
async function callSiteApi(path, body) {
    const url = `${exports.SITE_API_BASE}${path}`;
