...
exports.pipelineAuditTool = void 0;
exports.handlePipelineAudit = handlePipelineAudit;
const zod_1 = require("zod");
const client_js_1 = require("../../client.js");
const system_prompts_js_1 = require("../../prompts/system-prompts.js");
exports.pipelineAuditTool = {
    name: 'pipeline_audit',
    description: 'Audit a CI/CD pipeline configuration (GitLab CI, GitHub Actions, Tekton, Jenkins) for DoD DevSecOps compliance. Returns a scored audit with violations and hardened pipeline YAML.',
    inputSchema: {
        type: 'object',
        properties: {
            pipelineYaml: {
...
const Schema = zod_1.z.object({
    pipelineYaml: zod_1.z.string().min(1),
    pipelineType: zod_1.z.enum(['gitlab-ci', 'github-actions', 'tekton', 'jenkins']),
    targetLevel: zod_1.z.enum(['il2', 'il4', 'il5']).default('il4'),
    scanTools: zod_1.z.array(zod_1.z.string()).default([]),
});
async function handlePipelineAudit(args) {
