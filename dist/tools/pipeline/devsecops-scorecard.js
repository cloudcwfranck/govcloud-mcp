...
exports.devsecopsScoreCardTool = void 0;
exports.handleDevsecopsScorecard = handleDevsecopsScorecard;
const zod_1 = require("zod");
const client_js_1 = require("../../client.js");
const system_prompts_js_1 = require("../../prompts/system-prompts.js");
exports.devsecopsScoreCardTool = {
    name: 'devsecops_scorecard',
    description: 'Generate a DoD DevSecOps maturity scorecard for a software factory or program. Scores against the DoD DevSecOps Reference Design and CNCF security best practices. Returns a scored assessment with a prioritized improvement roadmap.',
    inputSchema: {
        type: 'object',
        properties: {
            ...
            currentCapabilities: {
                type: 'array',
                items: { type: 'string' },
                description: 'List current DevSecOps capabilities e.g. ["gitlab-ci","sonarqube","twistlock","vault","big-bang","tekton"]',
            },
            targetLevel: {
                type: 'string',
                enum: ['il2', 'il4', 'il5'],
...
const Schema = zod_1.z.object({
    ...
    currentCapabilities: zod_1.z.array(zod_1.z.string()),
    targetLevel: zod_1.z.enum(['il2', 'il4', 'il5']),
    softwareFactoryType: zod_1.z.enum(['platform-one', 'custom', 'iron-bank-consumer']).default('platform-one'),
});
async function handleDevsecopsScorecard(args) {
...
//# sourceMappingURL=devsecops-scorecard.js.map