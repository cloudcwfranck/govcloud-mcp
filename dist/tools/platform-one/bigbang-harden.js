...
exports.bigbangHardenTool = void 0;
exports.handleBigbangHarden = handleBigbangHarden;
const zod_1 = require("zod");
const client_js_1 = require("../../client.js");
const system_prompts_js_1 = require("../../prompts/system-prompts.js");
exports.bigbangHardenTool = {
    name: 'bigbang_harden',
    description: 'Generate a fully hardened Big Bang values.yaml targeting DoD IL4 or IL5 from scratch or from an existing values file. Includes Chainguard/Iron Bank digest-pinned images.',
    inputSchema: {
        type: 'object',
        properties: {
...
const Schema = zod_1.z.object({
    baseValues: zod_1.z.string().optional(),
    targetLevel: zod_1.z.enum(['il4', 'il5']),
    enabledAddons: zod_1.z.array(zod_1.z.string()).default(['istio', 'monitoring', 'logging', 'policy']),
    clusterName: zod_1.z.string().default('bb-cluster'),
    registryUrl: zod_1.z.string().default('registry1.dso.mil'),
});
async function handleBigbangHarden(args) {
...
//# sourceMappingURL=bigbang-harden.js.map