import { BASE_SYSTEM_PROMPT } from '../client.js';

export const COMPLIANCE_SYSTEM = `${BASE_SYSTEM_PROMPT}
...
export const ARCHITECTURE_SYSTEM = `${BASE_SYSTEM_PROMPT}
...
export const PLATFORM_ONE_SYSTEM = `${BASE_SYSTEM_PROMPT}
...
export const PIPELINE_SYSTEM = `${BASE_SYSTEM_PROMPT}
...
export const DOCUMENT_SYSTEM = `${BASE_SYSTEM_PROMPT}
